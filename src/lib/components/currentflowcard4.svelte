...
{value: '12000', qualifiers: Array(1), dateTime: '2023-05-08T15:30:00.000-07:00'},
{value: '10000', qualifiers: Array(1), dateTime: '2023-05-08T15:45:00.000-07:00'},
{value: '9000', qualifiers: Array(1), dateTime: '2023-05-08T16:00:00.000-07:00'},
{value: '8000', qualifiers: Array(1), dateTime: '2023-05-08T16:15:00.000-07:00'},
...
const data = dataraw.map(item => ({
  x: new Date(item.dateTime).toLocaleString('en-US', {
    month: 'numeric',
    day: 'numeric',
    year: 'numeric',
    hour: 'numeric',
...
console.log(data);
    ...
    const xTicksFormatted = xTicks.map((el) => el.toLocaleString('en-US', { month: 'short', day: 'numeric', hour: 'numeric', minute: '2-digit' }));
